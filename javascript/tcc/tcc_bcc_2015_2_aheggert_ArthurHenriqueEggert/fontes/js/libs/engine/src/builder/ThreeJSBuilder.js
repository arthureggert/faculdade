var ThreeJSBuilder = new function () {
    ...
    this.createAtomObject = function (x, y, z, rgbColor) {
        var component = new AtomoRenderComponent().initialize(rgbColor);
        var object = this.createTemplateObject(x, y, z, 0, 0, 0, component, "ATOM_OBJECT");
        //object.threeObject.position.multiplyScalar(5);
        //object.threeObject.scale.multiplyScalar(5);
        return object;
    };

    this.createLigacaoObject = function (pontoOrigem, pontoDestino, translateOnX) {
        var component = new LigacaoRenderComponent().initialize(pontoOrigem, pontoDestino, translateOnX);
        var object = this.createTemplateObject(pontoOrigem.x, pontoOrigem.y, pontoOrigem.z, 0, 0, 0, component, "BOND_OBJECT");
        console.log(pontoOrigem.distanceTo(pontoDestino));
        object.threeObject.position.copy(pontoOrigem);
        object.threeObject.position.lerp(pontoDestino, 0.5);
        object.threeObject.scale.set(0.1, 0.1, pontoOrigem.distanceTo(pontoDestino));
        object.threeObject.lookAt(pontoDestino);
        object.threeObject.translateX(translateOnX);
        return object;
    };
};