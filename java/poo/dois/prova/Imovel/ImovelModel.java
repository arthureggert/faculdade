...
public class ImovelModel extends AbstractTableModel{

	private static final long serialVersionUID = 1L;
	private ArrayList<Imovel> listaDeImoveis = new ArrayList<Imovel>();
	private int qtdColunas = 9;
	...
	public ImovelModel() {
        ...
        this.nomeColunas[2] = "Propriet�rio";
        this.nomeColunas[3] = "Tel. Propriet�rio";
        this.nomeColunas[4] = "Endere�o";
        this.nomeColunas[5] = "Bairro";
        this.nomeColunas[6] = "Cidade";
        this.nomeColunas[7] = "Quartos";
        this.nomeColunas[8] = "Valor";
	}
