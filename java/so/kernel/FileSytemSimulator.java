...
public class FileSytemSimulator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        this.txtCommand = new javax.swing.JTextField();
        this.jScrollPane3 = new javax.swing.JScrollPane();
        this.jScrollPane1 = new javax.swing.JScrollPane();
        this.textArea = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("File System Simulator");
        setBackground(new java.awt.Color(1, 1, 1));

        this.txtCommand.setBackground(new java.awt.Color(0, 0, 0));
        this.txtCommand.setFont(new java.awt.Font("Courier New", 0, 14));
        this.txtCommand.setForeground(new java.awt.Color(255, 255, 255));
        this.txtCommand.setText("aluno@localhost:~$");
        this.txtCommand.setCaretColor(new java.awt.Color(255, 255, 255));
        this.txtCommand.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        this.txtCommand.setSelectedTextColor(new java.awt.Color(255, 255, 255));
        this.txtCommand.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        this.textArea.setBackground(new java.awt.Color(0, 0, 0));
        this.textArea.setColumns(20);
        this.textArea.setEditable(false);
        this.textArea.setFont(new java.awt.Font("Courier New", 0, 14));
        this.textArea.setForeground(new java.awt.Color(255, 255, 255));
        this.textArea.setRows(5);
        this.textArea.setSelectedTextColor(new java.awt.Color(255, 255, 255));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(this.txtCommand, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 502, Short.MAX_VALUE)
            .addComponent(this.jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 502, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(this.jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(this.txtCommand, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
        );

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void txtCommandKeyPressed(KeyEvent evt) {//GEN-FIRST:event_txtCommandKeyPressed
    ...
    private void txtCommandKeyReleased(KeyEvent evt) {//GEN-FIRST:event_txtCommandKeyReleased
