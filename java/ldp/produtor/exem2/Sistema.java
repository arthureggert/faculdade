...
public class Sistema {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		int numArmaProd;
		while (true) {
			numArmaProd = getEntrada(in, "Informe nro de �reas para armazenar produtos enviados pelos prod. : ");
			if (numArmaProd >= 1) {
				break;
			}
		}
		...
		while (true) {
			...
			while (true) {
				entArmaConsProd = getEntrada(in, "Informe nro de �reas para armazenar produtos enviados pelo cons./prod.: ");
